...
const BollingerBands = (props) => {
    ...
    function drawChart() {
        ...
        function N(){
            const form = `<form>
            <input name=i type=number min=1 max=100 value=20 step=1 style="width:40px;">
            <span style="font-size:smaller;font-style:oblique;">periods (N)</span>
          </form>`;
          ...
          function K() {
            const form = `<form>
            <input name=i type=number min=0 max=10 value=2 step=0.1 style="width:40px;">
            <span style="font-size:smaller;font-style:oblique;">standard deviations (K)</span>
          </form>`;
            form.i.oninput = () => form.value = form.i.valueAsNumber;
            form.i.oninput();
            return form;
        ...
        var margin = ({top: 10, right: 20, bottom: 30, left: 40})
            ...
            //     .style("overflow", "visible");
                ...
                [
                  ...
                  var values = Float64Array.from(data, d => d.close)
